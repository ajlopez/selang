...
// methods
pdef.define('method', [ '?visibility', '?xtype', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[2], values[1] || 'void' , values[0] || 'private', values[4], values[6]); });
