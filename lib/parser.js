...
pdef.define('contract', [ 'name:contract', 'name:', 'delimiter:{', 'commandlist', 'delimiter:}' ], function (values) { return geast.contract(values[1], geast.sequence(values[3])); });
...
pdef.define('method', [ 'type', 'name:', 'delimiter:(', 'delimiter:)', 'command' ], function (values) { return geast.method(values[1], values[0], 'private', [], values[4]); });
pdef.define('method', [ 'visibility', 'type', 'name:', 'delimiter:(', 'delimiter:)', 'command' ], function (values) { return geast.method(values[2], values[1], values[0], [], values[5]); });
