...
geast.node('variable', [ 'name', 'type', 'expression' ]);
...
// assignment command
pdef.define('command', [ 'name', 'operator:=', 'expression', 'delimiter:;' ], function (values) { return geast.assignment(values[0], values[2]); } );
// expression command
...
// methods
pdef.define('method', [ 'name:void', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[1], values[0], 'private', values[3], values[5]); });
pdef.define('method', [ 'visibility', 'name:void', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[2], values[1], values[0], values[4], values[6]); });
pdef.define('method', [ 'type', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[1], values[0], 'private', values[3], values[5]); });
pdef.define('method', [ 'visibility', 'type', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[2], values[1], values[0], values[4], values[6]); });
